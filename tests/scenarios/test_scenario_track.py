...
@pytest.mark.parametrize("mode", ("text", "csv"))
    ...
    with multiprocessing.Manager() as manager:
        ...
        with tempfile.TemporaryDirectory() as temp_d:
            _process = multiprocessing.Process(
                target=run_dummy_analysis_text
                if mode == "text"
            ...
            with multiparser.FileMonitor(
                ...
                monitor.run()
            _process.join()
        assert _counter_dict[mode] == N_FILES * N_FILE_LINES
